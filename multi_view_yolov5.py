...
def detect_drone(*args):
    ...
    return overall_conf/num_img


frame1 = cv2.imread('./night/frame_0.jpg')
frame2 = cv2.imread('./night/frame_389.jpg')
# frame2 = cv2
conf = detect_drone(frame1,frame2)
print(conf)
